	...
	<div class="custom-panel">
        ...
        <center style="width:25%;margin:0px auto;">
            <div class="input-group form-group">
                ...
                <input type="number" class="form-control" id="coplevel" value="<?php echo $player->coplevel ?>" max="<?php echo $settings["maxlevels"]["coplevel"] ?>">
            </div>
            <div class="input-group form-group">
                <span class="input-group-addon">Medic Level</span>
                <input type="number" class="form-control" id="mediclevel" value="<?php echo $player->mediclevel ?>" max="<?php echo $settings["maxlevels"]["mediclevel"] ?>">
            </div>
            <div class="input-group form-group">
                <span class="input-group-addon">Donor Level</span>
                <input type="number" class="form-control" id="donatorlvl" value="<?php echo $player->donatorlvl ?>" max="<?php echo $settings["maxlevels"]["donatorlvl"] ?>">
            </div>
        </center>
    </div>
</div>
